...
task spec_cov: %i[model_spec_cov web_spec_cov]
...
task :setup, [:name] do |_t, args|
  ...
  %w[views/layout.erb routes/prefix1.rb config.ru app.rb db.rb spec/web/spec_helper.rb
     spec/web/prefix1_spec.rb].each do |f|
